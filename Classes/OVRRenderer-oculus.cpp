...
OVRRendererOculus::OVRRendererOculus()
	: _mirrorFBO(0)
...
bool OVRRendererOculus::init(cocos2d::CameraFlag flag)
{
	OVR::System::Init();
...
OVRRendererOculus* OVRRendererOculus::create(cocos2d::CameraFlag flag)
{
	auto renderer = new OVRRendererOculus;
...
void OVRRendererOculus::update(float delta)
{
...
void OVRRendererOculus::onBeginDrawImp()
{
	glDepthMask(true);
...
void OVRRendererOculus::onEndDrawImp()
{
	int eye = Camera::getVisitingCamera() == _eyeCamera[0] ? 0 : 1;
